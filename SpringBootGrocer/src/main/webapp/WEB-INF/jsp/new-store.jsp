...
<body>
	...
	<!--  my code -->
	<div class="container mt-5 shadow-sm p-3 mb-5 bg-white rounded " style="width: 50vh; margin: auto;">

		<div class="container-fluid mb-3" >
			<h3 class="">Add New Store</h3>
		...
		<form action="/add-store" method="post" modelattribute="store">
			...
			<div class="form-group mb-3">
				...
				<input type="text" class="form-control"
					name="name" id="name" aria-label="Store name"
			...
			<div class="form-group mb-3">
				...
				<input type="tel" class="form-control"
					name="phone" id="phone" aria-label="Store phone number"
			...
			<div class="form-group mb-3">
				...
				<input type="text" class="form-control"
					name="des" id="des" aria-label="Store desc."
			...
			<div class="form-group mb-3">
				<label class="mb-2" for="customFile">Upload Media/Document</label> 
